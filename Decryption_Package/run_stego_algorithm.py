...
SECRET_MESSAGE_STRING = r"C:\Users\HOME\PYTHON CS\Project\Complete\Text\Animal Farm Extract.sty"

with open(SECRET_MESSAGE_STRING, "r") as messageFile:
    SECRET_MESSAGE_STRING = messageFile.read()
